...
1. **Formal Specification**
  1. [About](About.md) — Introduction to the AVM architecture and delineation of specification scope.
  1. [AVM Core Specification](AVM/index.md) — Comprehensive treatment of the system model, runtime context, instruction set architecture, interpreter semantics, and runtime implementation guidance.
...
1. **Reference Materials**
  ...
  1. [References](References.md) — Comprehensive bibliography and citation index.
